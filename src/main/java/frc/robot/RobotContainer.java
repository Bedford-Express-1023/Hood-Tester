...
public class RobotContainer {
  ...
  private final HoodPosition m_HoodPosition = new HoodPosition(m_ShooterSubsystem);
  private final HoodPositionReset m_HoodPositionReset = new HoodPositionReset(m_ShooterSubsystem);
